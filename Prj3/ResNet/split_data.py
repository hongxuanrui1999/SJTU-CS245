...
dataset_dir = os.path.join("Animals_with_Attributes2", "JPEGImages")
train_dir = os.path.join("Animals_with_Attributes2", "train")
valid_dir = os.path.join("Animals_with_Attributes2", "valid")
test_dir = os.path.join("Animals_with_Attributes2", "test")
